...
# Imports internes (votre code existant)
...
from src.countries.spain.AlCampoV3.model.product_alcampo import EvolutionAlcampo
...
from src.countries.spain.AlCampoV3.db.alcampoMongoRepoSetup import alcampo_product_repository
            ...
            for product_data in data:
                try:
                    ...
                    use_case = CreateOrUpdateEvolutionUseCase(
                        product_repository=alcampo_product_repository,
                        productSubClassType=EvolutionAlcampo
                    )
...
if __name__ == "__main__":
    print("alcampo uploader my main")
    cmdargs = sys.argv
   ...
   # --- MODE 1 : dossier brut de JSONs iAdetailed ---
    if os.path.isdir(input_path):
        ...
        json_files = [
            ...
            if "_iadetailed.json" in fname.lower()
        ]
        if not json_files:
