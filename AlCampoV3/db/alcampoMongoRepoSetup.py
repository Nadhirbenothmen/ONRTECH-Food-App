...
DB_NAME = "alcampo"
COLLECTION_NAME = "alcampo_collection"
"""
...
alcampo_product_repository = MongoProductRepository(mongo_client = mongo_client, db_name = DB_NAME, collection_name = COLLECTION_NAME)
