...
from src.countries.spain.EroskiV3.model.product_eroski import EvolutionEroski
...
from src.countries.spain.EroskiV3.db.eroskiMongoRepoSetup import eroski_product_repository
            ...
            for product_data in data:
                try:
                    ...
                    use_case = CreateOrUpdateEvolutionUseCase(
                        product_repository=eroski_product_repository,
                        productSubClassType=EvolutionEroski
                    )
