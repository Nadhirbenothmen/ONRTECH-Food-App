...
DB_NAME = "eroski"
COLLECTION_NAME = "eroski_collection"
"""
...
eroski_product_repository = MongoProductRepository(mongo_client = mongo_client, db_name = DB_NAME, collection_name = COLLECTION_NAME)
