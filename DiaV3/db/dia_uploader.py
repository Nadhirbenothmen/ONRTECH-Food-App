...
from src.countries.spain.DiaV3.model.product_dia import EvolutionDia
...
from src.countries.spain.DiaV3.db.diaMongoRepoSetup import dia_product_repository
            ...
            for product_data in data:
                try:
                    ...
                    use_case = CreateOrUpdateEvolutionUseCase(
                        product_repository=dia_product_repository,
                        productSubClassType=EvolutionDia
                    )
